                        ...
                        <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control date" placeholder="__/__/____" id="expires_at" name="expires_at" value="{{ old('expires_at') }}">
                                    @error('expires_at')
                                        <p class="mb-0 text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-4 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control currency" placeholder="R$" id="price" name="price" value="{{ old('price') }}">
                                    @error('price')
                                        <p class="mb-0 text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="iamge" class="form-label">Imagem <sup class="text-danger">*</sup></label>
